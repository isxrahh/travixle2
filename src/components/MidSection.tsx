...
import { HeartIcon, Star, StarIcon } from "lucide-react";
            ...
            {weekendDeals.map((deal) => (
              ...
              >
                <Card className="rounded-3xl py-4 gap-0 w-78">
                  <div className="group relative -top-[23.5px] rounded-t-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500">
                    <img
                      src={deal.imageUrl}
                      alt={deal.name}
                  ...
                  >
                    <Card className="h-[420px] rounded-3xl overflow-hidden flex flex-col gap-0">
                      <div className="relative">
                        ...
                        />
                        <div className="absolute top-0 right-4 bg-white/90 px-3 py-1 rounded-full text-sm font-semibold flex items-center gap-1.5">
                          <StarIcon className="w-4 h-4 fill-yellow-400 text-yellow-400" />
                          <span>{home.reviewPoint}</span>
                        </div>
                      </div>
                      ...
                      <CardContent className="text-gray-800 px-4 flex flex-col h-full">
                        ...
                        <p className="text-sm text-gray-700 mt-auto text-right">
                          Starting from{" "}
                          <span className="text-gray-900 text-lg font-bold ml-1">
                            {home.price}
                          </span>
                        </p>
                      </CardContent>
